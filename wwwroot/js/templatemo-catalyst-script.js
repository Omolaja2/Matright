...
function setPlan(plan) {
    ...
    if (plan === 'yearly') {
        ...
        if (toggleSave) toggleSave.classList.add('visible');
    } else {
        if (toggleMonthly) toggleMonthly.classList.add('active');
        if (toggleYearly) toggleYearly.classList.remove('active');
        if (toggleSave) toggleSave.classList.remove('visible');
    }
}

if (toggleMonthly) toggleMonthly.addEventListener('click', () => setPlan('monthly'));
if (toggleYearly)  toggleYearly.addEventListener('click',  () => setPlan('yearly'));
