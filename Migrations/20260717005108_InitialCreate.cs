        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OwnerPosition = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Capital_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Receipt = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    StoreId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Stores",
                columns: new[] { "Id", "Address", "CreatedAt", "Description", "Email", "IsActive", "IsDeleted", "LogoUrl", "Name", "OwnerName", "OwnerPosition", "Phone", "UpdatedAt" },
                values: new object[] { 1, null, new DateTime(2026, 7, 17, 0, 50, 14, 436, DateTimeKind.Utc).AddTicks(6623), null, null, true, false, null, "Default Store", null, null, null, null });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedAt", "Description", "IsDeleted", "Name", "StoreId", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 7, 17, 0, 50, 14, 437, DateTimeKind.Utc).AddTicks(7651), "General products", false, "General", 1, null },
                    { 2, new DateTime(2026, 7, 17, 0, 50, 14, 437, DateTimeKind.Utc).AddTicks(7656), "Electronic devices and accessories", false, "Electronics", 1, null },
                    { 3, new DateTime(2026, 7, 17, 0, 50, 14, 437, DateTimeKind.Utc).AddTicks(7659), "Food and grocery items", false, "Groceries", 1, null },
                    { 4, new DateTime(2026, 7, 17, 0, 50, 14, 437, DateTimeKind.Utc).AddTicks(7660), "Household essentials", false, "Household", 1, null },
                    { 5, new DateTime(2026, 7, 17, 0, 50, 14, 437, DateTimeKind.Utc).AddTicks(7662), "Personal hygiene products", false, "Personal Care", 1, null }
                });

            migrationBuilder.InsertData(
                table: "TaxSettings",
                columns: new[] { "Id", "CreatedAt", "IsDeleted", "IsEnabled", "StoreId", "TaxName", "TaxRate", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2026, 7, 17, 0, 50, 14, 438, DateTimeKind.Utc).AddTicks(504), false, true, 1, "VAT", 7.5m, null });

            migrationBuilder.CreateIndex(
                name: "IX_Capital_StoreId",
                table: "Capital",
                column: "StoreId");
